...
export default function Home() {
  return (
    <div className="text-center">
      <h1 className="text-4xl font-bold mb-8">Que como?</h1>
      ...
      <div className="mb-6 p-3">
        ...
        <div className="grid grid-cols-2 gap-4">
          <Link
            href="/add-food"
            className="bg-[#24C690] text-white p-4 rounded-xl hover:bg-green-900 transition duration-300 flex-col items-center justify-center shadow-xl"
          >
          ...
          <Link
            href="/food-list"
            className="bg-[#24C690] text-white p-4 rounded-xl hover:bg-green-900 transition duration-300 flex flex-col gap-1 items-center justify-center shadow-xl"
          >
            <div className="flex justify-center mb-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
